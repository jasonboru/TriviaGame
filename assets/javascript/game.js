...
var questions = [{
        ...
        answIndex: 0,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/milton.mp3",
...

    {
        ...
        answIndex: 1,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/einstein.mp3",
...

    {
        ...
        answIndex: 2,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/holmes.mp3",
...

    {
        ...
        answIndex: 3,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/campbell.mp3",
        quote: "<p>\"Computers are like Old Testament gods: lots of rules and no mercy.\"</p> <h3 class='text-center'>-Joseph Campbell</h3>",
...

    {
        ...
        answIndex: 0,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/aristotle.mp3",
...

    {
        ...
        answIndex: 1,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/sikorsky.mp3",
...

    {
        ...
        answIndex: 2,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/nobel.mp3",
...

    {
        ...
        answIndex: 3,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/jefferson.mp3",
...

    {
        ...
        answIndex: 0,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/virgil.mp3",
...

    {
        ...
        answIndex: 1,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/murrow.mp3",
...

    {
        ...
        answIndex: 2,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/newton.mp3",
...

    {
        ...
        answ: ["Virgil", "Juvenal", "Ovid", "Cicero"],
        answIndex: 3,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/cicero.mp3",
...

    {
        ...
        answIndex: 0,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/galileo.mp3",
...

    {
        ...
        answIndex: 1,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/ford.mp3",
...

    {
        ...
        answIndex: 2,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/asimov.mp3",
...

    {
        ...
        answIndex: 3,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/lazarus.mp3",
...

    {
        ...
        answIndex: 0,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/suntzu.mp3",
...

    {
        ...
        answIndex: 1,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/machiavelli.mp3",
...

    {
        ...
        answIndex: 2,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/twain.mp3",
...

    {
        ...
        answIndex: 3,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/themistocles.mp3",
...

    {
        ...
        answIndex: 0,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/oppenheimer.mp3",
...

    {
        ...
        answIndex: 1,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/malory.mp3",
...

    {
        ...
        answIndex: 2,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/carson.mp3",
...

    {
        ...
        answIndex: 3,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/hawthorne.mp3",
...

    {
        ...
        answIndex: 0,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/hawkins.mp3",
...

    {
        ...
        answIndex: 1,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/mcluhan.mp3",
...

    {
        ...
        answIndex: 2,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/yeats.mp3",
...

    {
        ...
        answIndex: 3,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/patton.mp3",
...

    {
        ...
        answIndex: 0,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/schwartz.mp3",
...

    {
        ...
        answ: ["Aristotle", "Plato", "Socrates", "Pythagoras"],
        answIndex: 2,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/socrates.mp3",
    ...
    {
        ques: "This philosopher, essayist, poet, and novelist is remembered in large part for his aphorisms, such as \"Only the dead have seen the end of war\" many of which have been so frequently used as to have become clichéd.",
        answ: ["Issac Asimov", "Joseph Campbell", "Bertrand Russell", "George Santayana"],
        answIndex: 3,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/santayana.mp3",
        quote: "<p>\"Those who cannot remember the past are condemned to repeat it.\"</p> <h3 class='text-center'>-George Santayana</h3>",
        img: "assets/images/santayana.jpg",
        imgWrong: "assets/images/santayana_x.jpg"
    },

    {
        ques: "Many of our moral-rich stories are credited to this Greek slave and storyteller.",
        answ: ["Aesop", "Socrates", "Virgil", "Spartacus"],
        answIndex: 0,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/aesop.mp3",
        quote: "<p>\"The haft of the arrow had been feathered with one of the eagle's own plumes. We often give our enemies the means of our own destruction.\"</p> <h3 class='text-center'>-Aesop</h3>",
        img: "assets/images/aesop.jpg",
        imgWrong: "assets/images/aesop_x.jpg"
    },

    {
        ques: "Perhaps best known as an artist, he was also an architect and a scientist. Yet, if asked, he would ultimately refer to himself as an engineer.",
        answ: ["Michelangelo", "Leonardo da Vinci", "Salvador Dali", "Pablo Pacaso"],
        answIndex: 1,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/davinci.mp3",
        quote: "<p>\"Instrumental or mechanical sciencce is the noblest and, above all others, the most useful.\"</p> <h3 class='text-center'>-Leonardo da Vinci</h3>",
        img: "assets/images/davinci.jpg",
        imgWrong: "assets/images/davinci_x.jpg"
    },

    {
        ques: "He is credited as one of the earliest European advocates of the modern scientific method inspired by Aristotle.",
        answ: ["Rene Descartes", "Galileo", "Roger Bacon", "Isaac Newton"],
        answIndex: 2,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/bacon.mp3",
        quote: "<p>\"Mathematics is the gate and key to the sciences.\"</p> <h3 class='text-center'>-Roger Bacon</h3>",
        img: "assets/images/bacon.jpg",
        imgWrong: "assets/images/bacon_x.jpg"
    },

    {
        ques: "A renowned polymath, he was a major figure in the American Enlightenment and the history of physics for his discoveries and theories regarding electricity.",
        answ: ["Thomas Edison", "Michael Faraday", "Nikola Tesla", "Benjamin Franklin"],
        answIndex: 3,
        sound: "https://s3.amazonaws.com/job-ucf-code-bootcamp/civ-trivia-sounds/franklin.mp3",
        quote: "<p>\"There never was a good knife made of bad steel.\"</p> <h3 class='text-center'>-Benjamin Franklin</h3>",
        img: "assets/images/franklin.jpg",
        imgWrong: "assets/images/franklin_x.jpg"
    }
];
